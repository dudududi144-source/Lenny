...
/* Vertical Slice data-driven + נרטיב לכל עולם */
export class GameScene extends Phaser.Scene{
 private bg!:Phaser.GameObjects.Graphics;private dio!:Phaser.GameObjects.Graphics;
 private mg!:Phaser.GameObjects.Graphics;private fg!:Phaser.GameObjects.Graphics;private pg!:Phaser.GameObjects.Graphics;
 ...
 private drawOpt(x:number,y:number,type:string,o:string){const g=this.fg;
  ...
  else if(type==='music'){const yy=o==='high'?y-24:o==='mid'?y:y+24;g.fillStyle(0x4dc9ff,1);g.fillCircle(x,yy,10);g.lineStyle(2,0x4dc9ff,1);g.lineBetween(x+9,yy,x+9,yy-26);}
  else if(type==='emotion'){g.fillStyle(0xffe0c2,1);g.fillCircle(x,y,22);g.fillStyle(0x2a2140,1);g.fillCircle(x-7,y-5,3);g.fillCircle(x+7,y-5,3);g.lineStyle(2,0xc2405e,1);
